...
if ( $mode == 15 ) {
$query1="select S_PDF_MARGE_TOP, S_PDF_MARGE_LEFT, S_PDF_TEXTE_TOP, S_PDF_TEXTE_BOTTOM
        from section
        where S_ID=0";
...
$y = $S_PDF_TEXTE_TOP;  
    ...
    while (custom_fetch_array($result)) { 
        ...
        if ( $mode == 7 ) { // facture
            ...
            $pdf->SetXY(25,$y);
            $pdf->SetFont('Arial','',11);
            $pdf->MultiCell(160,6,"Je ".$soussigne.", ".$chef_long.", convoque ".$TC_LIBELLE." ".$nom_prenom." à participer à l'événement suivant".$y.":","","J");
            $y = $y + 20;

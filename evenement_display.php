...
if ( $tab == 2  or $tab == 61 or $print ) {
    ...
    if ($child == 1) {
        ...
        if  ( $tableau_visible ) {
            ...
            $query="select distinct e.E_PARENT, ep.EP_DATE, ep.E_CODE as EC, p.P_ID, p.P_NOM, ".phone_display_mask('p.P_PHONE')." P_PHONE, p.P_PRENOM, p.P_CODE, p.P_GRADE, g.G_DESCRIPTION, g.G_ICON, s.S_ID, 
            ...
            if ( $nbparticipants > 0 or $NP > 0 ) {
                ...
                while (custom_fetch_array($result)) {
                    ...
                    if ( ! $print or ! $full_absent ) {
                        ...
                        echo "<td style='padding-left:3px;'><a href=upd_personnel.php?pompier=$P_ID title=\"$extcmt\">".$altcolor.strtoupper($P_NOM)." ".my_ucfirst($P_PRENOM)." - $P_CODE $cmt</a>";
